  ...
  <page-card>
    ...
    <v-list v-else two-line>
      <v-list-tile v-for="board in boardsCollection" :key="board.address" @click="selectBoard(board)">
        ...
        <v-list-tile-avatar>
          <firmware-update-button :board="board" @click="openDialog('update', board)" />
        </v-list-tile-avatar>
    ...
    <boards-update-dialog :board="tempBoard" :open="dialogs.update" @close="dialogs.update = false" />
...
import FirmwareUpdateButton from '../Firmware/FirmwareUpdateButton'
import BoardsRenameDialog from './BoardsRenameDialog'
import BoardsRemoveDialog from './BoardsRemoveDialog'
import BoardsUpdateDialog from './BoardsUpdateDialog'
  ...
  data () {
    return {
      ...
      actions: [
        ...
        { dialog: 'update', title: 'Update', icon: 'update' },
